...
public class TrailerCursor extends AbstractCursor implements TrailerModel {
    ...
    public String getTrailerKey() {
        String res = getStringOrNull(TrailerColumns.TRAILER_KEY);
        if (res == null)
    ...
    public String getTrailerSite() {
        String res = getStringOrNull(TrailerColumns.TRAILER_SITE);
        if (res == null)
            throw new NullPointerException("The value of 'trailer_site' in the database was null, which is not allowed according to the model definition");
        return res;
    }
}
